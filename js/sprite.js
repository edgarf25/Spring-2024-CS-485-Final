...
function preload() {
    ...
    bg1 = loadImage('imgs/' + path + '/1.jpg')
    bg2 = loadImage('imgs/' + path + '/2.jpg')
    bg3 = loadImage('imgs/' + path + '/3.jpg')
    bg4 = loadImage('imgs/' + path + '/4.jpg')
    bg5 = loadImage('imgs/' + path + '/5.jpg')
    bg6 = loadImage('imgs/' + path + '/6.jpg')
}